...
import { Profile, GateAccessLog, VehicleReport, ReportStatus, UserRole } from '../types';
import { useToast } from '../contexts/ToastContext';
import { SearchIcon, ScanIcon, LogOutIcon, LogInIcon, AlertTriangleIcon, CarIcon, ClockIcon, HistoryIcon, MapPinIcon } from '../components/icons';
    ...
    const handleSearch = async (e?: React.FormEvent) => {
        ...
        try {
            ...
            const { data: wantedReports, error } = await supabase
                ...
                .in('status', [ReportStatus.PENDING, ReportStatus.SIGHTED, ReportStatus.IN_PROGRESS])
