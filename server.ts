...
async function runMigrations() {
    ...
    const queries = [
        ...
        "UPDATE public.companies SET allowed_modules = ARRAY['controller', 'ems_dispatch', 'tech_ops', 'fleet_management', 'guard_monitoring', 'gate_access', 'attendance', 'analytics', 'archives'] WHERE allowed_modules IS NULL;",
