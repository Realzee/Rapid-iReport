        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            <div className="relative bg-gray-900/50 border border-gray-700/50 rounded-2xl shadow-2xl p-8 w-full max-w-md mx-4 text-center">
                ...
                <div className="mt-3 text-center sm:mt-5">
                    <h3 className="text-lg leading-6 font-medium text-white" id="modal-title">Delete Company</h3>
                    <div className="mt-2">
                        <p className="text-sm text-gray-400">
                            Are you sure you want to delete <strong className="text-white">{companyName}</strong>? This will remove the company but not its users. They will become unassigned. This action cannot be undone.
                        </p>
                    </div>
                </div>
