                ...
                <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="mt-2">
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                            Are you sure you want to delete the report for <strong className="text-gray-800 dark:text-white">{reportIdentifier}</strong>? This action will move the report to the Incident Archives and remove it from all active views.
                        </p>
                    </div>
                </div>
