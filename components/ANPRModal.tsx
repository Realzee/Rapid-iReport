...
const ANPRModal: React.FC<ANPRModalProps> = ({ isOpen, onClose, onReportFound }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 overflow-y-auto bg-black/75 backdrop-blur-sm" onClick={onClose}>
            <div className="relative bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-2xl p-4 sm:p-6 w-full max-w-lg my-auto max-h-[92vh] overflow-y-auto flex flex-col" onClick={e => e.stopPropagation()}>
